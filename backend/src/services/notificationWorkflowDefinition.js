...
export function notificationVariableCatalog(extraOutputFields = []) {
  ...
  return [
    ...
    variable('requester.locationKey', 'Requester location key', 'Requester', 'Normalized requester site key for workflow routing. Brisbane normalizes to AU-BRISBANE.', 'AU-BRISBANE'),
    variable('requester.regionKey', 'Requester region key', 'Requester', 'Normalized requester region key for workflow routing. Brisbane normalizes to AU-BRISBANE.', 'AU-BRISBANE'),
