...
export function notificationVariableCatalog(extraOutputFields = [], { customFieldDefinitions = [] } = {}) {
  ...
  return [
    ...
    variable('ticket.sentiment', 'Requester sentiment', 'Ticket', 'How the requester sounds in their own messages: positive, neutral or frustrated. On "Ticket arrived" and "Requester replied" it is read fresh from this message; blank when unknown.', 'neutral'),
    ...
    variable('requester.onStraightTalkList', 'On the Straight-Talk List', 'Requester', 'True when this person is on the workspace Straight-Talk List (Settings > Tone of voice) and always gets a plain, professional reply.', 'false'),
