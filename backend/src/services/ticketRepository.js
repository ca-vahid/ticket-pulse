  ...
  async upsert(data) {
    try {
      const updatePayload = {
        ...
        fwdEmails: data.fwdEmails !== undefined ? data.fwdEmails : undefined,
        lastIngestSource: data.lastIngestSource !== undefined ? data.lastIngestSource : undefined,
        lastIngestedAt: data.lastIngestedAt !== undefined ? data.lastIngestedAt : undefined,
        lastWebhookIngestedAt: data.lastWebhookIngestedAt !== undefined ? data.lastWebhookIngestedAt : undefined,
        webhookIngestCount: data.incrementWebhookIngestCount ? { increment: 1 } : undefined,
      ...
      const createPayload = {
        ...
        fwdEmails: data.fwdEmails || [],
        lastIngestSource: data.lastIngestSource || null,
        lastIngestedAt: data.lastIngestedAt || null,
        lastWebhookIngestedAt: data.lastWebhookIngestedAt || null,
        webhookIngestCount: data.incrementWebhookIngestCount ? 1 : 0,
