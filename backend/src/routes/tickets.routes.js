...
router.post('/oauth-clients', requireTicketingAdmin, asyncHandler(async (req, res) => {
  ...
  const client = await oauthClientService.create(req.workspaceId, {
    ...
    trustedIntake: req.body?.trustedIntake, structureOwnTicketsOnly: req.body?.structureOwnTicketsOnly, ipAllowlist: req.body?.ipAllowlist, defaultSource: req.body?.defaultSource,
  }, req.ticketActor);
