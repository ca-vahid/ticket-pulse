...
**Fix (3.9.68-preview, same night) — built; re-check applied on ticketpulse@ since 22 Sep: 3 replies attached to #242611 and written to FreshService (Ray ×2 as requester, Vahid marked), 3 Jira auto-submitted skips, 2 already ingested:**
