...
// works on every page it's mounted on, including the bespoke Settings/Visuals
// chrome that bypasses AppShell/AppHeader.
//
...
export default function SideRail() {
  ...
  return (
    <nav
      ...
      className="tp-side-rail fixed inset-y-0 left-0 z-50 hidden w-[58px] flex-col gap-1 overflow-hidden border-r border-slate-200/80 bg-white/90 py-3 shadow-subtle backdrop-blur-md transition-[width] duration-200 ease-out hover:w-[210px] focus-within:w-[210px] motion-reduce:transition-none md:flex print:hidden"
    >
      <button
        type="button"
