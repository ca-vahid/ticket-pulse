  ...
  renderFallback() {
    ...
    const card = (
      <div className="tp-card mx-auto w-full max-w-md p-6 text-center shadow-soft" role="alert">
        <div className="mx-auto mb-3 flex h-11 w-11 items-center justify-center rounded-full bg-red-50 dark:bg-red-500/15">
        ...
        <div className="mt-4 flex items-center justify-center gap-2">
          ...
          <button
            ...
            className="tp-focus-ring inline-flex items-center gap-1 rounded-lg border border-border bg-card px-3 py-2 text-sm font-medium text-muted-foreground transition-colors hover:bg-muted/50"
          >
            Details
        ...
        {showDetail && (
          <pre className="settings-scrollbar mt-4 max-h-48 overflow-auto rounded-md bg-muted/50 p-3 text-left text-[11px] leading-relaxed text-muted-foreground">
