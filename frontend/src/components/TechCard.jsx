...
import { EyeOff, Trophy, Star, Inbox, Hand, Send, CheckSquare, Users } from 'lucide-react';
...
export default function TechCard({ technician, onHide, rank, selectedDate, selectedWeek, maxOpenCount = 10, maxDailyCount = 1, viewMode = 'daily', searchTerm = '', selectedCategories = [] }) {
  ...
  const totalOpenCount = technician.openTicketCount || 0; // Open + Pending combined
  ...
  return (
    ...
    >
      ...
      <div className="p-4">
        ...
        {/* Metrics Grid - Icons + Numbers (3 columns now) */}
